...
(() => {
  ...
  function loadPackage(metadata) {
    ...
    var PACKAGE_NAME = "/home/panjie/apx/work/kvazaar-org/src/kvazaar.data";
    var REMOTE_PACKAGE_BASE = "kvazaar.data";
    ...
    function runWithFS(Module) {
      ...
      function processPackageData(arrayBuffer) {
        ...
        Module["removeRunDependency"]("datafile_/home/panjie/apx/work/kvazaar-org/src/kvazaar.data");
      }
      Module["addRunDependency"]("datafile_/home/panjie/apx/work/kvazaar-org/src/kvazaar.data");
  ...
  loadPackage({
    "files": [ {
      "filename": "/asset_dir/waterfall_cif.yuv",
      "start": 0,
      "end": 39536640
    } ],
    "remote_package_size": 39536640
  });
})();

// end include: /tmp/tmp5rzgxzfz.js
// include: /tmp/tmpy8f1jnk8.js
...
// end include: /tmp/tmpy8f1jnk8.js
// include: /tmp/tmp6yuxzne5.js
...
// end include: /tmp/tmp6yuxzne5.js
...
async function instantiateAsync(binary, binaryFile, imports) {
  if (!binary && typeof WebAssembly.instantiateStreaming == "function" && !isDataURI(binaryFile) && !ENVIRONMENT_IS_NODE && !ENVIRONMENT_IS_SHELL) {
    try {
